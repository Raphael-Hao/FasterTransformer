...
def generate_start_ids(request_bs, input_len, id_range=50255):
    import random
    import csv

    with open("start_ids.csv", "w", newline="") as csvfile:
...
if __name__ == "__main__":
    ...
    generate_start_ids(args.request_bs, args.input_len)